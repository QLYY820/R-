...
# study. This script is designed for the bastion/RStudio environment where the
# full nurse dataset has already been loaded as a data.frame named `data`.
#
# Usage in RStudio:
...
if (!exists("NEGATIVE_CODES_AS_MISSING")) NEGATIVE_CODES_AS_MISSING <- TRUE
